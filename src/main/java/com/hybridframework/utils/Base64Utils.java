...
public final class Base64Utils {
    ...
    /**
     * Encodes a EnvironmentSecretKey to Base64 string.
     *
     * @param secretKey the EnvironmentSecretKey to encode
     * @return the Base64 encoded string
     * @throws IllegalArgumentException if the input is null
     */
    ...
    /**
     * Decodes a Base64 string to a EnvironmentSecretKey.
     *
     * @param encodedKey the Base64 encoded key string
     * @return the decoded EnvironmentSecretKey
     * @throws IllegalArgumentException if the input is null or invalid Base64
     */
    public static SecretKey decodeSecretKey(String encodedKey) {
        ...
        try {
            ...
            return new SecretKeySpec(decodedKey, CryptoConstants.AES_ALGORITHM.getStringValue());
        } catch (Exception error) {
